...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = []  # list of tuples (question, answer)
...
def addTo_vector_store(text_chunks):
    ...
    vector_store.save_local("faiss_pdfindex")
...
def main():
    st.set_page_config("Chat PDF - Sliding Window Memory")
    st.header("Chat with PDF Files (Last 4 Turns Memory)")
